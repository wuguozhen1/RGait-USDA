...
class DSAN(nn.Module):
    ...
    def __init__(self, num_classes=31, bottle_neck=True):
        ...
        self.feature_layers = ResNet.resnet50(True)#使用其训练参数
    ...
    def forward(self, source, target, s_label):
        ...
        loss_lmmd,loss_entry = self.lmmd_loss.get_loss(source, target, s_label, torch.nn.functional.softmax(t_label, dim=1))
        return s_pred,loss_lmmd,loss_entry
